...
export function WelcomeModal() {
  ...
  useEffect(() => {
    ...
    const hasSeenTutorial = localStorage.getItem("brew-board-welcomed");
    if (!hasSeenTutorial) {
      // Pequeño retraso para que la animación de entrada de la página termine primero
  ...
  const handleClose = () => {
    setIsOpen(false);
    localStorage.setItem("brew-board-welcomed", "true");
  };

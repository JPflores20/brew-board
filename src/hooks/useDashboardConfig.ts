  ...
  mantenimiento: {
    cards: [
      ...
      { id: "grafana", label: "GRAFANA", url: "https://10.182.4.106/?orgId=1&search=open" },
      {
        id: "sorba",
        label: "SORBA (FILTROS)",
        url: "https://10.40.11.15/dashboard/d/4tSDQa_Sk01/zac_ftr_op_dashboard?orgld=1&refresh=10s",
      },
